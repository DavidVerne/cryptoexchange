// RENDERS REALTIME BITCOIN PRICES AND MONTHLY CHANGES
import React, { Component } from 'react';
import moment from 'moment';
import '../../stylesheets/Stellar/InfoBox.css';
...
class InfoBox extends Component {
    ...
    componentDidMount() {
        this.getData = () => {
            ...
            const url = 'https://min-api.cryptocompare.com/data/price?fsym=XLM&tsyms=USD';
