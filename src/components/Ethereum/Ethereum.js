...
import '../../stylesheets/Ethereum/Ethereum.css';
...
class Ethereum extends Component {
    ...
    componentDidMount() {
        const getData = () => {
            const url = 'https://min-api.cryptocompare.com/data/histoday?fsym=ETH&tsym=USD&limit=30';
            ...
            fetch(url).then(r => r.json())
                .then((cryptoprice) => {
                    ...
                    console.log('ethereum data: ', this.state.data);
                })
                .catch((e) => {
                    console.log(e);
                });
    ...
    render() {
        return (
            ...
            <div className='container monthly-title'>
                <div className='row'>
                    <h5>30 Day Ethereum Price Chart</h5>
                </div>
                <div className='row'>
