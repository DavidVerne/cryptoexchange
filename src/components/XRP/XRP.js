...
import '../../stylesheets/XRP/XRP.css';
...
class XRP extends Component {
    ...
    componentDidMount() {
        const getData = () => {
            const url = 'https://min-api.cryptocompare.com/data/histoday?fsym=XRP&tsym=USD&limit=30';
            ...
            fetch(url).then(r => r.json())
                .then((cryptoprice) => {
                    ...
                    console.log('XRP data: ', this.state.data);
                })
                .catch((e) => {
                    console.log(e);
                });
